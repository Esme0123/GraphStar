...
const constellationsData = [
    { 
      ...
      img: process.env.PUBLIC_URL + 'IMG/andromeda.jpg',
    },
    { 
      id: 'orion', 
      name: 'Orión', 
      ...
      img: process.env.PUBLIC_URL + 'IMG/orion.jpg',
    },
    { 
      id: 'gemini', 
      name: 'Géminis', 
      ...
      img: process.env.PUBLIC_URL + 'IMG/geminis.jpg',
    },
    { 
      id: 'pegasus', 
      name: 'Pegaso', 
      ...
      img: process.env.PUBLIC_URL + 'IMG/pegaso.jpg',
    }
];
...
const WelcomeSortPage = ({ onGoToSimulator, onGoBack }) => {
    ...
    return (
        <div className="welcome-page">
                ...
                <div className="constellations-grid">
                    {constellationsData.map(item => (
                        <div key={item.id} className="constellation-item" onClick={() => setActiveConstellation(item)}>
                            <img src={item.imageUrl} alt={item.name} className="constellation-image" />
            ...
            {/* Pasamos los datos al InfoModal, que ya sabe cómo mostrar 'name' e 'info' */}
