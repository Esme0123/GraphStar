...
const planetsData = [
    ...
    { id: 'jupiter', name: 'Júpiter', concept:'Algoritmo de Asignación',info: 'Información sobre Júpiter próximamente...' , size:140},
    { id: 'marte', name: 'Marte',concept:'Algoritmo de Johnson', info: 'Es un potente algoritmo para encontrar los caminos más cortos entre todos los pares de nodos, incluso si hay aristas con pesos negativos. Lo logra transformando los pesos para luego poder usar el rápido algoritmo de Dijkstra desde cada nodo. Detecta ciclos negativos para evitar resultados infinitos.' ,size:70},
